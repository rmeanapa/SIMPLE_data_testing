mkdir -p not; cd not
simple_exec prg=new_project projname=not dir=./ > LOG 2>&1
filetab_movs.pl /mnt/beegfs/elmlund/testing-datasets/Not/20240316_223846_67_80S_Not_module_monoG_2s_min20/movies >> LOG 2>&1
...
simple_exec prg=motion_correct nparts=5 nthr=8 gainref=/mnt/beegfs/elmlund/testing-datasets/Not/20240316_223846_67_80S_Not_module_monoG_2s_min20/gain/20240315_170616_EER_GainReference.gain total_dose=54 smpd_downscale=1.3 >> LOG 2>&1
echo " >>> PROGRAM: ctf_estimate" >> LOG 2>&1
simple_exec prg=ctf_estimate nparts=5 nthr=8 projfile=2_motion_correct/not.simple >> LOG 2>&1
