...
simple_exec prg=motion_correct nparts=5 nthr=8 gainref=/mnt/beegfs/elmlund/testing-datasets/MotAB/20220708_141209_csMotAB_FliGc_short_linker_1_3mgml_3s_bfmin5/gain/20220708_141047_EER_GainReference.gain total_dose=56.5 smpd_downscale=1.3 >> LOG 2>&1
echo " >>> PROGRAM: ctf_estimate" >> LOG 2>&1
simple_exec prg=ctf_estimate nparts=5 nthr=8 projfile=2_motion_correct/motab.simple >> LOG 2>&1
