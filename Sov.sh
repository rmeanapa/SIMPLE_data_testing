...
simple_exec prg=motion_correct nparts=24 nthr=1 gainref= total_dose=59.3 smpd_downscale=1.3 >> LOG 2>&1
echo " >>> PROGRAM: ctf_estimate" >> LOG 2>&1
simple_exec prg=ctf_estimate nparts=24 nthr=1 projfile=2_motion_correct/Sov.simple >> LOG 2>&1
...
simple_exec prg=extract box=256 nparts=24 nthr=1 projfile=4_pick/Sov.simple >> LOG 2>&1
