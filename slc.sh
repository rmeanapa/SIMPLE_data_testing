mkdir -p slc; cd slc
simple_exec prg=new_project projname=slc dir=./ > LOG 2>&1
filetab_movs.pl /mnt/beegfs/elmlund/testing-datasets/SLC/20231213_152517_63_SLCO2A1_3_PGE2_2s_min20/movies >> LOG 2>&1
...
simple_exec prg=motion_correct nparts=24 nthr=1 gainref=
total_dose=54.526 smpd_downscale=1.3 >> LOG 2>&1
echo " >>> PROGRAM: ctf_estimate" >> LOG 2>&1
simple_exec prg=ctf_estimate nparts=24 nthr=1 projfile=2_motion_correct/slc.simple >> LOG 2>&1
filetab_mrc.pl 2_motion_correct/ >> LOG 2>&1
echo " >>> PROGRAM: pick" >> LOG 2>&1
simple_exec prg=pick picker=segdiam projfile=3_ctf_estimate/slc.simple nparts=24 nthr=1 >> LOG 2>&1
echo " >>> PROGRAM: extract" >> LOG 2>&1
simple_exec prg=extract box=256 nparts=24 nthr=1 projfile=4_pick/slc.simple >> LOG 2>&1
...
#smpd=0.693
#dose=54.526
#dir=/mnt/beegfs/elmlund/testing-datasets/SLC/20231213_152517_63_SLCO2A1_3_PGE2_2s_min20
...
#AVERAGE CTF RESOLUTION               :     3.66
#STANDARD DEVIATION OF CTF RESOLUTION :     3.04
#MINIMUM CTF RESOLUTION (BEST)        :     2.80
#MAXIMUM CTF RESOLUTION (WORST)       :    50.00
#AVERAGE DF                           :     1.55
#STANDARD DEVIATION OF DF             :     0.56
#MINIMUM DF                           :     0.20
#MAXIMUM DF                           :     4.97
